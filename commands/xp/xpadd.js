    ...
    run: async (client, messageCreate, args) => {
        try {
            ...
            if (args[0] >= 10000) {
                ...
                db.add(`${messageCreate.guild.id}_${messageCreate.author.id}_exp.xp`, args[0])
                ...
                while (db.get(`${messageCreate.guild.id}_${messageCreate.author.id}_exp.xp`) >= curlvl * 300) {
                ...
                let newlvl = (db.get(`xp.${messageCreate.guild.id}.${target.id}.level`)) // Current Level
                let newxp = (db.get(`xp.${messageCreate.guild.id}.${target.id}.xp`)) // Current Xp
                ...
                messageCreate.channel.send(levelEmbed);
